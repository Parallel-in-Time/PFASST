...
namespace examples
{
  namespace boris
  {
                                    ...
                                    const size_t nparticles, const size_t niters)
    {
      ...
      auto sweeper = make_shared<examples::boris::BorisSweeper<double, double>>(impl_solver);
...
{
  examples::boris::enable_config_options<double>();
  ...
  examples::boris::run_boris_sdc<double>(nsteps, dt, nnodes, nparticles, niters);
}
#endif
