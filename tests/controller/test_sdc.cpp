...
typedef pfasst::transfer_traits<void, SweeperType> TransferTraits;
...
TEST_F(Interface, communicator_can_not_be_assigned)
{
  EXPECT_THROW(controller->communicator() = comm, logic_error);
}
